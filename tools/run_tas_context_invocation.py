"""Explicit TAS verified context invocation corpus composition through the existing generic runtime."""
import argparse
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "artifacts/tas-context-invocation.json")
