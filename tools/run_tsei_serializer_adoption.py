"""Explicit TSEI serializer/adoption corpus composition through the existing generic runtime."""
import argparse
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "artifacts/tsei-serializer-adoption.json")
