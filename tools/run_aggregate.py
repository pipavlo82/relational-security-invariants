"""Aggregate Budget profile composition through the unchanged generic pipeline."""
import argparse,sys
...
def main():
    p=argparse.ArgumentParser();p.add_argument('--include-previous',action='store_true');p.add_argument('--output',type=Path,default=ROOT/'artifacts/aggregate.json');a=p.parse_args()
