"""Explicit semantic-abi claim edge corpus composition through the existing generic runtime."""
import argparse
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "artifacts/semantic-abi.json")
