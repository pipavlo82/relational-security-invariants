"""Explicit RVR corpus composition through the existing generic runtime."""
import argparse
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "artifacts/rvr-digest-binding.json")
