"""Explicit verify-layer account proof corpus composition through the existing generic runtime."""
import argparse
...
def main():
    ...
    parser.add_argument("--output", type=Path, default=ROOT / "artifacts/verify-layer.json")
